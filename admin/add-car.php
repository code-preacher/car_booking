...
extract($_POST);
 $ct=$_POST['ct'];
  if ($ct=='TAXI') {
   ...
   $ctt='BUS';
   $cid='BUS_'.str_shuffle(rand(uniqid(),99999999));
  }


$date=date("d-m-y @ g:i A");
$da=mysqli_query($con,"insert into car(cartype,cid,name,model,color,dname,dno,date) values('$ctt','$cid','$name','$model','$color','$dname','$dno','$date')");
if ($da) {
       ...
       <form action="#" method="post">
          <div class="form-group">
            <div class="form-label-group">
             ...
             <div class="form-group">
              <div class="form-label-group">        
              <select name="ct" id="inputCT" required="required" autofocus="autofocus" class="form-control" style="height: 60px;">  
              <option>Select Car Type</option> 
               <option value="TAXI">TAXI</option>
               <option value="BUS">BUS</option>
              </select>
              <label for="inputCT"></label>
            </div>
