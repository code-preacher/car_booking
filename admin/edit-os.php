    ...
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
       <form action="#" method="post">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="Car" class="form-control" value="<?php echo $tx['cartype'] ?>" disabled="disabled" required="required" autofocus="autofocus">
              <label for="Car">Selected Car Type</label>
            </div>
          </div>
           ...
           <div class="form-group">
              ...
              <select name="pn" required="required" autofocus="autofocus" class="form-control" style="height: 60px;">
               ...
               ?>
                <option value="<?php echo 'Car : '.$f['name'].' '.$f['model'].',Driver : '.$f['dname'].' '.$f['dno'];  ?>"><?php echo 'Car Type : '.$f['cartype'].' '.', Car : '.$f['name'].' '.$f['model'].', Driver : '.$f['dname'].' : '.$f['dno'];  ?></option>
