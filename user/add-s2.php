...
$da=mysqli_query($con,"insert into booking(name,email,routes,price,payment_ref,payment_status,delivery_status,cartype,car,time,date,date_created) values('$cn','$em','$pn','$pr','$rf','0','0','$ctt','','$tm','$dt','$date')");
if ($da) {
